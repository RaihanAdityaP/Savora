...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  Future<void> _showFollowersList() async {
    try {
      final response = await supabase
          .from('follows')
          .select('follower_id, profiles!follows_follower_id_fkey(username, avatar_url, full_name)')
          .eq('following_id', widget.userId);
  ...
  Future<void> _showFollowingList() async {
    try {
      final response = await supabase
          .from('follows')
          .select('following_id, profiles!follows_following_id_fkey(username, avatar_url, full_name)')
